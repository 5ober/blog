...
![](/blog/img/rocketmq/文件操作和网络操作.png)通过使用mmap的方式，可以省去向用户态的内存复制，提高速度。这种机制在Java中是通过MappedByteBuffer实现的
...
![](/blog/img/rocketmq/同步刷盘和异步刷盘.png)
...
![](/blog/img/rocketmq/RocketMQ角色.jpg)
...
![](/blog/img/rocketmq/消息发送高可用设计.jpg)
...
![](/blog/img/rocketmq/producer负载均衡.png)
...
![](/blog/img/rocketmq/consumer负载均衡.png)

还有另外一种平均的算法是AllocateMessageQueueAveragelyByCircle，也是平均分摊每一条queue，只是以环状轮流分queue的形式，如下图：

![](/blog/img/rocketmq/consumer负载均衡2.png)
...
![](/blog/img/rocketmq/consumer负载均衡3.png)
...
![](/blog/img/rocketmq/死信队列主题.png)

2. 在消息界面根据主题查询死信消息

![](/blog/img/rocketmq/死信队列主题2.png)
...
![](/blog/img/rocketmq/源码6.png)

#### 1）启动NameServer

* 展开namesrv模块，右键NamesrvStartup.java

![](/blog/img/rocketmq/源码3.png)

* 配置**ROCKETMQ_HOME**

![](/blog/img/rocketmq/源码4.png)

![](/blog/img/rocketmq/源码5.png)
...
![](/blog/img/rocketmq/源码7.png)

![](/blog/img/rocketmq/源码8.png)
...
![](/blog/img/rocketmq/NameServer启动流程.png)
...
![](/blog/img/rocketmq/实体数据实例.png)

![](/blog/img/rocketmq/实体数据实例2.png)

#### 2.2.3.2 路由注册

#####1）发送心跳包

![](/blog/img/rocketmq/路由注册.png)
...
![](/blog/img/rocketmq/NameServer处理路由注册.png)
...
![](/blog/img/rocketmq/NameServer小结.png)

## 2.3 Producer

消息生产者的代码都在client模块中，相对于RocketMQ来讲，消息生产者就是客户端，也是消息的提供者。

![](/blog/img/rocketmq/DefaultMQProducer类图.png)

###2.3.1 方法和属性

####1）主要方法介绍

![](/blog/img/rocketmq/MQAdmin.png)
...
![](/blog/img/rocketmq/MQProducer.png)
...
![](/blog/img/rocketmq/DefaultMQProducer属性.png)
...
![](/blog/img/rocketmq/Topic路由信息.png)
...
![](/blog/img/rocketmq/Broker故障延迟机制核心类.png)
...
![](/blog/img/rocketmq/DefaultMessageStore.png)
...
![](/blog/img/rocketmq/MappedFileQueue.png)
...
![](/blog/img/rocketmq/MappedFile.png)
...
![](/blog/img/rocketmq/TransientStorePool.png)
...
![](/blog/img/rocketmq/构建消息消费队列和索引文件.png)
...
![](/blog/img/rocketmq/DispatchRequest.png)
...
![](/blog/img/rocketmq/消息分发到消息消费队列.png)
...
![](/blog/img/rocketmq/消息分发到索引文件.png)
...
![](/blog/img/rocketmq/文件恢复总体流程.png)
...
![](/blog/img/rocketmq/GroupCommitRequest.png)
...
![](/blog/img/rocketmq/DefaultMQPushConsumer.png)
...
![](/blog/img/rocketmq/消息消费启动流程.png)
...
![](/blog/img/rocketmq/pullMessageService实现机制.png)
...
![](/blog/img/rocketmq/PullRequest.png)
...
![](/blog/img/rocketmq/ProcessQueue.png)
...
![](/blog/img/rocketmq/消息拉取基本流程.png)
...
![](/blog/img/rocketmq/消息服务端Broker组装消息.png)
...
![](/blog/img/rocketmq/消息拉取客户端处理消息.png)
...
![](/blog/img/rocketmq/PullStatus.png)
...
![](/blog/img/rocketmq/消息拉取流程总结.png)
...
![](/blog/img/rocketmq/ConsumeMessageService.png)
