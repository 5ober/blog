...
![](/blog/img/rocketmq/下单失败流程图.png)

<u>使用MQ保证在下单失败后系统数据的完整性</u>

![](/blog/img/rocketmq/下单时序图(2).png)
...
![](/blog/img/rocketmq/支付流程.png)

<u>通过MQ进行数据分发，提高系统处理性能</u>

![](/blog/img/rocketmq/支付成功数据分发流程图.png)
...
![](/blog/img/rocketmq/12.支付后回调.png)
